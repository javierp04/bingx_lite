<div class="mb-4">
    <h1 class="h3 mb-0">
        <i class="fas fa-key me-2"></i>Edit API Key
    </h1>
</div>
            ...
            <div class="card-body">
                <?= form_open('apikeys/edit/' . $api_key->id) ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="api_secret" name="api_secret" value="<?= set_value('api_secret', $api_key->api_secret) ?>" required>
                    </div>
