    ...
    <div class="col-md-4">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div id="mt_fields" style="display: none;">
                    <div class="mb-3">
                        <label for="template_timeframe_mt" class="form-label">Timeframe (Minutes)</label>
                        <select class="form-select form-select-sm" id="template_timeframe_mt">
