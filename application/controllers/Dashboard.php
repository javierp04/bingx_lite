...
class Dashboard extends CI_Controller {
    ...
    public function test_spot_balance() {
        ...
        if ($result) {
            $this->session->set_flashdata('success', 'Spot balance retrieved successfully: ' . json_encode($result));
        } else {
    ...
    public function test_futures_balance() {
        ...
        if ($result) {
            $this->session->set_flashdata('success', 'Futures balance retrieved successfully: ' . json_encode($result));
        } else {
    ...
    public function test_price() {
        ...
        if ($spot_price) {
            ...
            // Si falla, intentar precio de futuros
            ...
            if ($futures_price) {
                ...
                $this->session->set_flashdata('error', 'Failed to get price for ' . $symbol . ': ' . $this->bingxapi->get_last_error());
            }
        }
